	 ...
	 <div class="row">
	 	 <div class="col-sm-4">
			  ...
			  <label for="name">Name:</label> <span style="color:red">*</span>
			  	<input type="text" name="name" ng-model="name" class="form-control" id="name" placeholder="Color name" required="">
			</div>
	 </div>
	  <div class="col-sm-4">
	 	 	<div class="form-group">
			  <label for="desc">Description:</label>
			  	<input type="text" name="description" ng-model="description" class="form-control" id="desc" placeholder="Color description">
			</div>
	 </div>
