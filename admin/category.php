     ...
     <div class="col-sm-3">
      <div class="form-group">
        <label for="name">Name:</label> <span style="color:red">*</span>
          <input type="text" name="name" ng-model="name" class="form-control" id="name" placeholder="Category name" required="">
      </div>
   </div>
    <div class="col-sm-3">
      <div class="form-group">
        <label for="desc">Description:</label>
          <input type="text" name="description" ng-model="description" class="form-control" id="desc" placeholder="Category description">
      </div>
   </div>
  
   <div class="col-sm-3">
    <div class="form-group">
      <label for="catagory">Parent Category:</label>
      <select name="categoryId" ng-model="categoryId" class="form-control">  
          <option value="">Select Category</option>  
          <option ng-repeat="ct in Items" value="{{ct.id}}">{{ct.name}}</option>  
       </select> 
    </div>
   </div>
  </div>  
    ...
    <div class="col-sm-12">
      ...
      <thead>
        ...
        <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" >Name</th>
         ...
         <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1">Parent Category</th> 
...
$scope.insertData = function(){  
      if($scope.btnName == "Add"){
           $http.post(  
                ...
                {'name':$scope.name, 'description':$scope.description, 'categoryId':$scope.categoryId,'request_type':2 }  
