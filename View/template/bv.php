...
?>
		...
		<ul class="breadcrumb">
			...
			<li><a href="#!bv">Business Volume</a></li>
		</ul>
						...
						<div class="row">
							...
							<div class="short-by-show form-inline text-right col-md-7 col-sm-8 col-xs-12">
								...
								<div class="form-group">
									...
									<select id="input-limit" class="form-control" ng-model="limit" ng-change="ppbv()">
							...
							<div class="box-pagination col-md-3 col-sm-4 col-xs-12 text-right">
								<ul class="pagination" ng-if="lid <= 6">
									<li ng-repeat="n in tlp" class="{{n == active ? 'active':''}}">
										<a ng-click="pgbv(n)" > <span>{{n+1}}</span></a>
									</li>
									<li ng-repeat-end" class="{{n == active ? 'active':''}}">
										<a ng-click="pgbv(lid-1)" > <span>>>|</span></a>
									</li>
								</ul>
								<ul class="pagination" ng-if="lid >= 7">
									...
									<li class="{{(lid-1) == active ? 'active':''}}">
										<a ng-click="pgbv(lid-1)"> <span>{{lid}}</span></a>
									</li>
									<li >
										<a ng-click="pgbv(n=n+1)" > <span>>|</span></a>
									</li>
	...
	<div class="product-layout col-md-4 col-sm-6 col-xs-12 " ng-repeat="pd in bproduct">
		<div class="product-item-container" style="height: 450px;">
			...
			<div class="right-block">
				<div class="caption">
					<h4><a href="#!quickview/{{pd.xitemid}}">{{pd.xdesc }}<br>{{ pd.xitemcode}}</a></h4>		
					<div class="ratings">
