...
?>
		...
		<ul class="breadcrumb">
			...
			<li><a href="#!shop/all">ABL Product</a></li>
		</ul>
...
<ul id="cat_accordion" class="list-group" ng-repeat="cat in xcat">
					...
					<!-- <div class="category-derc">
						<div class="row">
							<div class="col-sm-12">
								<div class="banners">
									<div>
										<a  href="#"><img src="View/image/demo/shop/category/electronic-cat.png" alt="Apple Cinema 30&quot;"><br></a>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="short-by-show form-inline text-right col-md-7 col-sm-8 col-xs-12">
								...
								<div class="form-group">
									...
									<select id="input-limit" class="form-control" ng-model="limit" ng-change="pp()">
							...
							<div class="box-pagination col-md-3 col-sm-4 col-xs-12 text-right">
								<ul class="pagination" ng-if="lid <= 6">
									<li ng-repeat="n in tlp" class="{{n == active ? 'active':''}}">
										<a ng-click="pg(n)" > <span>{{n+1}}</span></a>
									</li>
									<li ng-repeat-end" class="{{n == active ? 'active':''}}">
										<a ng-click="pg(lid-1)" > <span>>>|</span></a>
									</li>
								</ul>
								<ul class="pagination" ng-if="lid >= 7">
									...
									<li class="{{(lid-1) == active ? 'active':''}}">
										<a ng-click="pg(lid-1)"> <span>{{lid}}</span></a>
									</li>
									<li >
										<a ng-click="pg(n=n+1)" > <span>>|</span></a>
									</li>
	...
	<div class="product-layout col-md-4 col-sm-6 col-xs-12 " ng-repeat="pd in product">
			...
			<div class="right-block">
				<div class="caption">
				  ...
				  <div class="button-group">
					<button class="addToCart" type="button" data-toggle="tooltip" title="Add to Cart" ng-click="add(pd.xitemid,1,pd.xdesc,pd.xitemcode+'.jpg',pd.xmrp,pd.xstdprice,pd.xitemcode,pd.xsource,pd.xdp)" onclick="openNav()"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">Add to Basket</span></button>
