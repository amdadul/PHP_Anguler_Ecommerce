...
<div ng-include="'View/template/head.php'"></div>
	<!-- //Header Container  -->
	<!-- Main Container  -->
	<div  ng-init="corporate()">
			<div  ng-init="corporate_p()">
				<div  ng-init="cat()">
...
<div class="module latest-product titleLine">
	...
	<div class="product-layout col-md-4 col-sm-6 col-xs-12 " ng-repeat="pd in cproduct">
			...
			<div class="right-block">
				<div class="caption">
				  ...
				  <div class="button-group">
					<button class="addToCart" type="button" data-toggle="tooltip" title="Add to Cart" ng-click="addc(pd.xitemid,1,pd.xdesc,pd.xitemcode+'.jpg',pd.xmrp,pd.xsup,pd.xitemcode,pd.xdp)" onclick="openNav()"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">Add to Basket</span></button>
