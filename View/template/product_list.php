...
<script type="text/javascript">     
    function PrintDiv() {    
	var pageTitle = 'Amarbazar Ltd.',
		stylesheet = '//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css';
       var divToPrint = document.getElementById('PrintDiv');
       var popupWin = window.open('', '_blank', 'width=600,height=300');
       popupWin.document.open();
       popupWin.document.write('<html><head><title>' + pageTitle + '</title>' +
	...
	<div class="modcontent">
		...
		<li class="hadchild"><a href="#!shop/{{cat}}" class="cutom-parent">{{cat}}</a><span class="button-view  fa fa-circle"></span>
			...
			<div id="content" class="col-md-9 col-sm-8">
				 <button class="btn btn-primary" align="center" value="print" onclick="PrintDiv();" >Download or Print</button>
