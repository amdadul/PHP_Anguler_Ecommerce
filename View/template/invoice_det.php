...
<div ng-include="'View/template/head.php'"></div>
	...
	<div  ng-init="invoice_det()">
      ...
      <thead>
        <tr role="row">
        	<th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" >SI</th>
          <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" >Product Description</th>
        <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1" >Quantity </th>
         <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1">Rate</th>     
         <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1">Discount</th>     
         ...
         <th class="sorting" tabindex="0" aria-controls="table" rowspan="1" colspan="1">Total</th>         
          ...
          <tbody>
                 <tr ng-repeat="inv in invoicedet">
                 	
          <td>{{ $index+1 }}</td>
          <td>{{inv.xdesc}}</td>
         <td>{{inv.xqty}}</td>
          <td>{{inv.xsalesprice}}</td>
          <td>{{inv.xdisc}}</td>
          <td>{{inv.xpoint}}</td>
          <td>{{inv.xqty * inv.xsalesprice}}</td>
